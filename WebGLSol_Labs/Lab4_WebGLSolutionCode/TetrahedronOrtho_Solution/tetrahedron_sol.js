...
//*** change here - to see green triangle - bottom one
...
function render (){
        ...
        eye = vec3(radius*Math.sin(theta)*Math.cos(phi), radius*Math.sin(theta)*Math.sin(phi),
