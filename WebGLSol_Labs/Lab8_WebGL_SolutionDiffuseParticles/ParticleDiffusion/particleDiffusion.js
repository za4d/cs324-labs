...
window.onload = function init() {
    ...
    gl.vertexAttribPointer( vTexCoord, 2, gl.FLOAT, false, 0, 32+8*numPoints );// size of this buffer is given by:
                                                                                // space for the original rectangle onto which I'm rendering (32 bytes for the vertices) 
                                                                                // 8 bytes for each point
...
// move particles in a random direction
    ...
    for(var i=0; i<numPoints; i++) {
        ...
        // wrap arounds when position reaches the edge of the image 
