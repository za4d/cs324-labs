...
void draw_triangle()
{
	...
	glEnd();
	for(int i = 0;i<3;i++){
	  vertex[1][i] = vertex[1][i]-vertex[0][i];
	  vertex[2][i] = vertex[2][i]-vertex[0][i];
	  std::cout<<vertex[0][i]<<" "<<vertex[1][i]<<" "<<vertex[2][i]<<"\n";
	}
	normal[0] = (vertex[1][1] * vertex[2][2]) - (vertex[1][2] * vertex[2][1]);
	normal[1] = (vertex[1][2] * vertex[2][0]) - (vertex[1][0] * vertex[2][2]);
	normal[2] = (vertex[1][0] * vertex[2][1]) - (vertex[1][1] * vertex[2][0]);
