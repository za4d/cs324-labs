...
void display()
{
	...
	// specify texture coordinates
  	glBegin (GL_QUADS);
  		glTexCoord2f (0.5f,0.0f); // lower left corner
  		glVertex2i(0, 0);
  		glTexCoord2f (1.0f, 0.5f); // lower right corner
  		glVertex2i(g_window_width, 0);
  		glTexCoord2f (0.5f, 1.0f); // upper right corner
  		glVertex2i(g_window_width, g_window_height);
  		glTexCoord2f (0.5f, 0.50f); // upper left corner
